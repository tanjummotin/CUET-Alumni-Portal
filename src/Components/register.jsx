                ...
                <div className="card-body p-5">
                  ...
                  <form>
                    <div className="form-outline mb-4">
                      ...
                      <input type="text" className="form-control form-control-lg" name="name" id="name" value={nameField} onChange={(e) => setNameField(e.target.value)} />
                    </div>
                    ...
                    <div className="form-outline mb-4">
                      ...
                      <div className="form-outline mb-4">
                      <label className="form-label" for="blood_group">Blood Group</label>
                      ...
                      <div className="form-outline mb-4">
                      <label className="form-label" for="batch">Your batch(HSC)*</label>
                      ...
                      <div className="form-outline mb-4">
                      <label className="form-label" for="present_position">Your Designation</label>
                      ...
                      <div className="form-outline mb-4">
                      <label className="form-label" for="organization">Your Current Organization</label>
                      ...
                      <div className="form-outline mb-4">
                      <label className="form-label" for="phone_no">Your Phone No*</label>
                      ...
                      <div className="form-outline mb-4">
                      <label className="form-label" for="present_position">Present Address*</label>
